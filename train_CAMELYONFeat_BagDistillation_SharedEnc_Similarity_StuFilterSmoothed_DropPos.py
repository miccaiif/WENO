...
class Optimizer:
    ...
    def optimize_teacher(self, epoch):
        ...
        patch_label_gt_PosBag = patch_label_gt[patch_corresponding_bag_label == 1]
        patch_label_pred_normed_PosBag = patch_label_pred_normed[patch_corresponding_bag_label == 1].detach()
