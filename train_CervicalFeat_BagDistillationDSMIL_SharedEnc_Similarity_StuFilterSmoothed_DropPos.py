...
from Datasets_loader.dataset_CervicalCancer import CervicalCaner_16_feat
import datetime
import utliz
import util
import random
...
def get_parser():
    ...
    parser.add_argument('--comment', default='DEBUG_BagDistillation_DSMIL_BasedOnFeat', type=str, help='name for tensorboardX')
...
if __name__ == "__main__":
    ...
    val_ds_return_bag = CervicalCaner_16_feat(train=False, return_bag=True)
